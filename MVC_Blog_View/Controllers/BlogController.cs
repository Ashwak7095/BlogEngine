...
namespace MVC_Blog_View.Controllers
{
    public class BlogController : Controller
    {
        ...
        ////public async Task<IActionResult> Login()   //https://localhost:44345/api/Authentication/login Model
        ////{
        ////    return View();
        ////}
        ...
        ////    HttpContent context = new StringContent(strPayload, Encoding.UTF8, "application/json");
        ////    var response = client.PostAsync("api/Authentication/login Model", context).Result;
